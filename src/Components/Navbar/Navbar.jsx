...
// Use the uploaded file path as the logo source (local dev path)
  ...
  return (
    <header
      className={[
        ...
        isScrolled ? "navbar--scrolled shadow-md backdrop-blur" : "navbar--top",
      ].join(" ")}
    >
      <div className="container mx-auto px-3 lg:px-6">
        <div className="flex items-center justify-between gap-4 py-3 md:py-4">
          ...
          <Link
            ...
            aria-label="Future Plan Help - Home"
          >
            <img
              src={Logo}
              alt="Future Plan Help"
          ...
          >
            <AiOutlineMenu className="text-3xl icon--brand" style={{ color: "var(--wp-text)" }} />
          </button>
        </div>
      </div>
      ...
      >
        <div className="relative h-full flex flex-col">
          ...
          <div className="flex items-center justify-between px-5 pt-5 pb-3 border-b">
            ...
            >
              <img src={Logo} alt="Future Plan Help" className="h-9 w-auto" />
              <span style={{ color: "var(--wp-text)", fontWeight: 600 }}>Future Plan Help</span>
            </Link>
            ...
            >
              <AiOutlineClose className="text-3xl icon--brand" style={{ color: "var(--wp-text)" }} />
            </button>
          </div>
